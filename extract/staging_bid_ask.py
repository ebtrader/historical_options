...
class TestApp(EWrapper, EClient):
    ...
    def historicalDataOperations_req(self):
        ...
        self.reqHistoricalData(4104, self.contract, '',
                               "5 D", "5 mins", "BID", 1, 1, False, [])
        self.reqHistoricalData(4105, self.contract, '',
                               "5 D", "5 mins", "ASK", 1, 1, False, [])
        self.reqHistoricalData(4106, self.contract, '',
                               "5 D", "5 mins", "TRADES", 1, 1, False, [])
